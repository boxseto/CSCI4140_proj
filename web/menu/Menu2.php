<!-- PROGRAM MENU2 - Program to insert menu to SQL server
     PROGRAMMER: Vincent Chow
     CALLING SEQUENCE: <form action="Menu2.php" method="post">
...
<?php
  ...
  //insert data to database
	$sql = "INSERT INTO menu (Restaurant, Dishes, Price) VALUES ('$Restaurant', '$Dishes', '$Price')";

	if(!mysqli_query($con, $sql))
	{
		$fmsg = 'Failed to Insert Menu';
	}
	else
	{
		$smsg = 'Menu Inserted Successfully';
	}
?>
...
<link href="menu_styles.css" rel="stylesheet">
  ...
  <div class="module">
	<form action="Menu2.php" method="post">
		...
		<select name="Restaurant" class="textbox">
	...
	<input type="text" placeholder="Please input the dish" name="Dishes" class="textbox">
	<input type="text" placeholder="Please input the price(HKD $) of the dish" name="Price" class="textbox">
	<br>
